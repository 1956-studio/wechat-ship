...
router.get("/chatUser", auth.Auth, chatUser.index);
router.get('/chatUser/:id', auth.Auth, chatUser.detail);
router.post('/chatUser/:id', auth.Auth, chatUser.update);
router.delete('/chatUser/:id', auth.Auth, chatUser.delete);
